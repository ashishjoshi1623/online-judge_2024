    ...
    <>
        ...
        <section className='solve'>
            ...
            <div className='leftDesc'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="currentColor" className="bi bi-clock-history" viewBox="0 2 20 16">
  ...
  <path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5"/>
            ...
            <div className="codeEditor">
                ...
                <div className="codeSubmitBtnDiv">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="currentColor" className="bi bi-play-fill" viewBox="5 0 10 16">
  <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393"/>
</svg> Run</button>
                  <button onClick={handleSubmit} className='px-3 codeSubmitBtn'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="currentColor" className="bi bi-upload" viewBox="0 2 22 16">
